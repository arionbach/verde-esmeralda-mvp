...
export async function DELETE(_req: NextRequest, { params }: Params) {
 ...
 DEPRECATED: rota antiga; PUTDELETE oficial em apipredios ainda a definir
 srcappapiunidades[id]route.ts
import { NextRequest } from "nextserver";
import { z } from "zod";
...
export async function PUT(req: NextRequest, { params }: Params) {
  try {
    console.warn("[DEPRECATED] apiunidades:id called", {
      unidadeId: params.id,
      method: "PUT",
      referer: req.headers.get("referer")  undefined,
    });
