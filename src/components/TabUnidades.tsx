// src/components/TabUnidades.tsx
'use client'
...
function normalizeUnidade(u: any): Unidade {
  ...
  const responsavelAtivo = u.responsaveis?.find((r: any) => r.ativo) || 
                           u.responsavel || 
                           null
  ...
  return {
    ...
    valorTaxa: typeof u.valorTaxa === 'number' ? u.valorTaxa : Number(u.valorTaxa || 0),
...
export default function TabUnidades({
  ...
  console.log('Unidades recebidas:', itens)
      ...
      {unidadesNormalizadas.length === 0 ? (
        <div className="p-10 text-center text-gray-600 bg-gray-50 rounded-lg border border-dashed">
          ...
          <div className="mt-4">
            <Link 
              href={`/predios/${predioId}/unidades`}
              className="text-verde-esmeralda-600 hover:text-verde-esmeralda-700 font-medium"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          {unidadesNormalizadas.map((u) => {
            ...
            const valorTaxa = typeof u.valorTaxa === 'number' 
              ? u.valorTaxa 
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <div className="mt-1 text-sm text-gray-600">
                        {getTipoLabel(u.tipo)} • {u.metragem ? `${u.metragem} m²` : '—'}
                      </div>
                    </div>
                  ...
                  {u.responsavel && (
                    <div className="mt-4 rounded-xl border border-gray-100 bg-gray-50 px-3 py-2">
                      <div className="text-sm text-gray-600">
                        ...
                        {u.responsavel.nome} ({getTipoResponsavel(u.responsavel.tipo)})
                      </div>
